...
namespace Totomaro.Quest
{
    public enum MatchType
    {
        ...
        THREE_FOUR  = 7,    // 3 + 4 Match -> CLEAR_CIRCLE , CLEAR_HORZ 또는 VERT 퀘스트
        THREE_FIVE  = 8,    // 3 + 5 Match -> CLEAR_CIRCLE , CLEAR_LAZER 퀘스트
        FOUR_FIVE   = 9,    // 4 + 5 Match -> CLEAR_ALLCLEAR 퀘스트
        FIVE_FIVE   = 10,   // 5 + 5 Match -> CLEAR_ALLCLEAR 퀘스트
        FOUR_FOUR   = 11,   // 4 + 4 Match -> CLEAR_ALLCLEAR 퀘스트
    }
