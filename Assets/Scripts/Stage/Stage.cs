...
namespace Totomaro.Stage
{
    public class Stage
    {
        ...
        /// <param name="monsterPrefab">Board Prefab</param>
        /// <param name="playerPrefab">Board Prefab</param>
        ...
        public IEnumerator CoDoSwipeAction(int nRow, int nCol, Swipe swipeDir, Returnable<bool> actionResult)
        {
            ...
            while (IsValideSwipe(nRow, nCol, swipeDir))
            {
                ...
                nRow += swipeDir.GetTargetRow();
                nCol += swipeDir.GetTargetCol();
                nSwipeRow += swipeDir.GetTargetRow(); //Right : +1, LEFT : -1
                nSwipeCol += swipeDir.GetTargetCol(); //UP : +1, DOWN : -1  
            }
